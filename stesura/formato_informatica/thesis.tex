...
Quest'ultima fase è dedicata a finalizzare le migliori tecniche trovate, rimuovendo il vincolo delle 100 epoche, fissando il learning rate a $0,001$ oltre la 100-esima epocha e interrompendo l'allenamento al raggiungimento del miglior valore di accuratezza sul dataset di validazione.
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
$86,84$  & $91,89$ & $81,78$ & rimoz $0$ + 3BAR GLOB + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
$85,70$ &  $89,80$ &  $81,59$ & rimoz $0$ + 3BAR + norm & $15$ & & $4$ \\ \hline
$85,35$ &  $89,22$ &  $81,47$ & rimoz $0$ + NEXT 3 + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
\end{tabular}
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
$82,51$  & $87,47$  & $77,55$ & rimoz $0$ + 3BAR + norm & $10$ &   & $4$ \\ \hline
$81,55$  & $85,60$  & $77,50$ & rimoz $0$ + 3BAR GLOB + norm & $15$ &   & $4$ \\ \hline
$79,39$  & $83,78$  & $74,99$ & rimoz $0$ + NEXT 3 + norm & $15$ &  $10^{-5}$ & $4$ \\ \hline
\end{tabular}
...
In questa fase, visti i risultati ottenuti nella fase precedente dalla tecnica dei 3 baricentri è stato deciso di testare anche la variante dei 3 baricentri globali indicato con \emph{3BAR GLOB} in tabella.
...
Adesso che siamo riusciti a trovare quali le tecniche migliori su tutto il dataset possiamo combinarle fra loro per verificare se una loro cooperazione può aiutare o meno la classificazione. Il risultato finale sarà quindi la media delle inferenze generate dai due modelli in combinazione. Per ogni combinazione abbiamo ripetuto l'addestramento seguendo lo stesso procedimento adottato per gli altri test e quello che abbiamo ottenuto è rappresentato in tabella \ref{tab:combinazioneTecnicheDetectron} e \ref{tab:combinazioneTecnichePosenet}.
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
\multirow{2}{*}{$88,12$}  &  \multirow{2}{*}{$92,91$}  &  \multirow{2}{*}{$83,32$}& rimoz $0$ + 3BAR GLOB + norm & $15$ & $10^{-5}$ & $4$ \\
 & &  & rimoz $0$ + NEXT 3 + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
\multirow{2}{*}{$85,05$}  &  \multirow{2}{*}{$90,23$}  &  \multirow{2}{*}{$79,87$}& rimoz $0$ + 3BAR GLOB + norm & $15$ & $10^{-5}$ & $4$ \\
 & &  & rimoz $0$ + 3 BAR + norm & $15$ & & $4$ \\ \hline
\end{tabular}
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
\multirow{2}{*}{$81,56$}  &  \multirow{2}{*}{$85,39$}  &  \multirow{2}{*}{$77,74$}& rimoz $0$ + 3BAR GLOB + norm & $15$ & $10^{-5}$ & $4$ \\
 & &  & rimoz $0$ + NEXT 3 + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
\multirow{2}{*}{$...$}  &  \multirow{2}{*}{$...$}  &  \multirow{2}{*}{$...$}& rimoz $0$ + 3BAR PERS + norm & $10$ &  & $4$ \\
 & &  & rimoz $0$ + NEXT 3 + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
\end{tabular}
...
\item il classificatore ``\emph{3BAR-Posenet}" con un accuratezza Cross subject di $77,55\%$ e Cross view di $87,47\%$.
\end{itemize}
...
MMTM \cite{MMTM}						&  \checkmark & \checkmark & & -  &   91.99 & - \\ \hline
DSSCA-SSLM \cite{DSSCA-SSLM} 			&  & \checkmark  & & -     	&  74.9 & - \\ \hline 
\rowcolor{highlightColor} $\boldsymbol{3}$\textbf{BAR-PoseNet} 	& &  \checkmark  & & \textbf{87.47}     &   \textbf{77.55} & \textbf{82.51}\\ \hline
Chained  \cite{Chained} 					&   & \checkmark  & & -     	&   80.8 & - \\ \hline
