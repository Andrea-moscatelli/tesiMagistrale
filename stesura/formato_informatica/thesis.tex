...
$83,86$ & $88,44$ & $79,28$ &  rimoz $0$ + 3BAR + norm (MIN LOSS) & $15$ &  & $4$ \\ \hline
...
Quest'ultima fase è dedicata a finalizzare le miglior tecniche trovate, rimuovendo il vincolo delle 100 epoche, fissando il learning rate a $0,001$ e interrompendo l'allenamento al raggiungimento del miglior valore di accuratezza sul dataset di validazione.
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
$\boldsymbol{86,06}$  & $91,69$ & $80,43$ & rimoz $0$ + 3BAR GLOB + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
$85,70$ & $89,80$ & $\boldsymbol{81.59}$ & rimoz $0$ + 3BAR + norm & $15$ &  & $4$ \\ \hline
$85,18$ & $\boldsymbol{91,86}$ & $78,50$ & rimoz $0$ + 3BAR + norm & $15$ & $10^{-5}$ & $4$ \\ \hline
\end{tabular}
...
\thead{Media  \\ (\%) } & \thead{Cross  \\ View \\(\%)} &  \thead{Cross  \\ Subject \\(\%)} &  \multicolumn{1}{c|}{Tecnica} & \thead{Drop  \\ (\%) }  &  Reg & Liv \\
\hline
$\boldsymbol{80,89}$  & $\boldsymbol{85,99}$  & $\boldsymbol{75,80}$ & rimoz $0$ + 3BAR + norm & $15$ &  $$  & $4$ \\ \hline
\end{tabular}
...
\begin{itemize}
\item il classificatore ``\emph{3BAR-Detectron}" con un accuratezza Cross subject di $91,86\%$ e Cross view di $81,59\%$
\item il classificatore ``\emph{3BAR-Posenet}" con un accuratezza Cross subject di $75,80\%$ e Cross view di $85,99\%$.
\end{itemize}
...
\rowcolor{highlightColor} $\boldsymbol{3}$\textbf{-BAR-PoseNet} 	& &  \checkmark  & & \textbf{85.99}     &   \textbf{75.80} & \textbf{80.89}\\ \hline
...
\rowcolor{highlightColor} $\boldsymbol{3}$\textbf{-BAR-Detectron} 	& &  \checkmark  & & \textbf{91.86}     &   \textbf{81.59} & \textbf{86.73}\\ \hline
